...
class Ticket(Base):
    ...
    version_id = Column(UUID(as_uuid=True), ForeignKey("ticket_versions.id"), nullable=True)
    ...
    versions = relationship(
        ...
        foreign_keys="[TicketVersion.ticket_id]"
    )
...
class TicketVersion(Base):
    ...
    officer = relationship("Officer", back_populates="ticket_versions")
